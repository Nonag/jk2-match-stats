...
export { columnConfig, columnGroups, columnLabels, defaultColumnVisibility } from "./match-players-config";
export type { ColumnConfig, ColumnGroup } from "./match-players-config";
